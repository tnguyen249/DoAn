function nImgTrue = lbpSvm(m,n)
   lblTest = loadMNISTLabels('t10k-labels.idx1-ubyte');
    if exist(['LBPSVM',num2str(m),num2str(n),'.mat'], 'file') == 2
        load(['LBPSVM',num2str(m),num2str(n),'.mat']);
    else
        ...
        save(['LBPSVM',num2str(m),num2str(n),'.mat'],'lblResult');
    end
